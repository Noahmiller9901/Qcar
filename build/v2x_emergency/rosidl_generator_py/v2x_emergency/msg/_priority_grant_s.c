...
bool v2x_emergency__msg__priority_grant__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_emergency.msg._priority_grant.PriorityGrant", full_classname_dest, 47) == 0);
  }
  v2x_emergency__msg__PriorityGrant * ros_message = _ros_message;
  {  // intersection_id
  ...
  {  // green_duration
    PyObject * field = PyObject_GetAttrString(_pymsg, "green_duration");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->green_duration = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of PriorityGrant */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_emergency.msg._priority_grant");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PriorityGrant");
  ...
  {  // green_duration
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->green_duration);
    {
      int rc = PyObject_SetAttrString(_pymessage, "green_duration", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
