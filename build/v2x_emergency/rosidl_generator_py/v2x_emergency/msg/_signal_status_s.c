...
bool v2x_emergency__msg__signal_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_emergency.msg._signal_status.SignalStatus", full_classname_dest, 45) == 0);
  }
  v2x_emergency__msg__SignalStatus * ros_message = _ros_message;
  {  // intersection_id
...
PyObject * v2x_emergency__msg__signal_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_emergency.msg._signal_status");
