...
class Metaclass_PriorityGrant(type):
    """Metaclass of message 'PriorityGrant'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'v2x_emergency.msg.PriorityGrant')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__priority_grant
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__priority_grant
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__priority_grant
            cls._TYPE_SUPPORT = module.type_support_msg__msg__priority_grant
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__priority_grant
...
class PriorityGrant(metaclass=Metaclass_PriorityGrant):
    """Message class 'PriorityGrant'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.green_duration = kwargs.get('green_duration', float())
    ...
    def __eq__(self, other):
        ...
        if self.reason != other.reason:
            return False
        if self.green_duration != other.green_duration:
            return False
        return True
    ...
    def green_duration(self):
        """Message field 'green_duration'."""
        return self._green_duration

    @green_duration.setter
    def green_duration(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'green_duration' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'green_duration' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._green_duration = value
